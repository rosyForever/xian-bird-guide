...
> 本图鉴的信息可能存在错误、遗漏或过时之处，包括鸟种辨识、图片对应、出现月份与地点记录。欢迎大家通过本项目的 GitHub Issues 提交问题、补充观察记录，一起交流、核实并改进。
...
在本项目 GitHub 仓库的 **Issues → New issue** 中选择“纠错、补充与交流”。无论是发现错误、想补充鸟讯、讨论辨识依据，还是遇到使用问题，都欢迎提出。

反馈时尽量提供相关鸟名／地点、需要核对的内容、你的判断，以及可供核实的资料链接或观察照片；鸟讯可附观察月份和大致区域。不确定也可以先提出讨论，新的观察需要核实后再更新到图鉴中。

请避免提交私人联系方式或敏感巢址。仓库尚未发布时，可先记录问题，待项目上线后提交。
